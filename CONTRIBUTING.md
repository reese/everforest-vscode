...
The most critical files for a theme extension are some json files located in [/themes](https://github.com/reese/everforest-vscode/tree/master/themes), they defined all the colors of a theme.

A theme file can be roughly divided into three parts:

- [workbench colors](https://github.com/reese/everforest-vscode/blob/master/themes/gruvbox-material-dark.json#L25-L332): The UI of vscode.
- [syntax highlighting](https://github.com/reese/everforest-vscode/blob/master/themes/gruvbox-material-dark.json#L333-L2117): The syntax highlighting.
- [semantic highlighting](https://github.com/reese/everforest-vscode/blob/master/themes/gruvbox-material-dark.json#L5-L24): This is a new feature since vscode 1.43, see [Semantic Highlighting Overview](https://github.com/microsoft/vscode/wiki/Semantic-Highlighting-Overview). This feature is experimental, currently supports js, ts, java and C family.
...
- DO NOT add new colors or modify existing colors in [/src/palette](https://github.com/reese/everforest-vscode/tree/master/src/palette). The current color palettes are very carefully designed and tested on several devices. If you do want to change the color palettes, create a new theme extension instead.
...
- Don't forget to update [italic syntax file](https://github.com/reese/everforest-vscode/blob/master/src/syntax/italic.ts) if the syntax source code is modified.
